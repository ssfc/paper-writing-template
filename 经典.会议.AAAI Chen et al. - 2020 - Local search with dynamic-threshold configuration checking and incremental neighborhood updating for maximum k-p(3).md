...
challenge faced => previous methods to address challenges => methods categories

Category 1's methods => Category 1 methods' shortcomings => Category 2 methods => Category 2 methods' shortcomings => methods to address Category 2's shortcomings => shortcomings of methods to address Category 2's shortcomings => reason => this paper's method Component 1

previous methods => shortcomings of previous methods => this paper's method Component 2

construct this paper's method from Component 1 and Component 2 => experimental result

### Problem Notation

Graph => edge => vertex => neighbor => degree => edge density => set of neighbors => complement graph

k-plex => saturated set

local search => AddSet(S) \& SwpSet(S) \& PerturbSet(S)

### Mathematical principles of this paper's method

CC => variants of CC => variants shortcomings => this paper's method => Rules \& Lemmas
