...
remove component => compare with and without component

explain meaning of each table column => with component perform better OR worse than without component in which type of instances => proving effectiveness