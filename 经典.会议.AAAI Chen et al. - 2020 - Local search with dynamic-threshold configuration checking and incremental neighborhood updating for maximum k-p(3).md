...
research field of problem => parent problem => this paper's problem => this paper's problem applications

challenge faced => previous methods to address challenges

methods categories => Category 1's methods

Category 1 methods' shortcomings => Category 2 methods

Category 2 methods' shortcomings => methods to address Category 2's shortcomings

shortcomings of methods to address Category 2's shortcomings => reason => this paper's method Component 1
