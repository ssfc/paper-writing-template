...
方法相关符号: local search => partition of vertex set => candidate solution \& object value => edge weighting mechanism => move vertex color => score  (2023年6月26日)

### Theory of this paper's method

论文方法是一般性方法的特例: algorithm used for sampling maximal weighted cliques => this paper's incremental neighborhood updating scheme => implementation detail (Data Structures & Updating Rules & Complexity Analysis)  （Component 2）  (2023年6月19日)
