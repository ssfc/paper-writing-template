...
基本概念符号:  Graph => edge => vertex => degree of vertex => neighborhood of vertex => vertex weighted graph  (2023年6月25日)

问题相关符号:  GCP => WGCP  (2023年6月25日)

方法相关符号: local search => partition of vertex set => candidate solution  (2023年6月19日)
